...
void fem_new() {
    ...
    //fem.solve_segregation1(2000, EPS, 1.); // rz->xyz :Решение константа на элементе
    //fem.solve_segregation2(2000, EPS, 1.); // rz->xyz: Решение в узлах элемента
    //fem.solve_segregation3(2000, EPS, 1.); // rz->xyz: Точки Гауса?
